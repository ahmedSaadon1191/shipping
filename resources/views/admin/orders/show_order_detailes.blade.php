                               ...
                               @foreach ($order->orders_detailes as $item)
                                <div class="card-body">
                                    <div class="main-content-label mg-b-5">
                                        <h4>
                                            <strong>شحنة رقم   : {{ $item->id }}</strong>
                                        </h4>
                                    </div>
                                        ...
                                        <table class="table main-table-reference text-nowrap mg-t-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: #b91d7e; font-size:18px">{{ $item->order->servant->name }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="bg-gray-100 wd-20p" style="font-size: 18px"><b><strong>  حالة الشحنة :</strong></b></td>
                                                    <td style="color: #b91d7e; font-size:18px">{{ $item->product->status->name }}</td>
                                                </tr>
                                                <tr>
