				...
				<div class="nav nav-item  navbar-nav-right ml-auto">
					...
					<div class="dropdown main-profile-menu nav nav-item nav-link">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="{{ route('pro.edit') }}"><i class="bx bx-log-out"></i>تعديل الملف الشخصي</a>
							<a class="dropdown-item" href="{{ route('pro.change_password') }}"><i class="bx bx-log-out"></i>تعديل كلمة السر</a>
